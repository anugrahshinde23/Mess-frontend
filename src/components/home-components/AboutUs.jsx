...
const AboutUs = () => {
  return (
    ...
    <div className='h-screen w-full p-20 flex flex-col gap-5 overflow-hidden'>
      ...
      <div id='about-head' className='flex justify-between gap-5 shrink-0'> 
        <div className='w-1/2'>
      ...
      <div id='about-img' className="flex-1 overflow-hidden rounded-2xl shadow-xl border border-gray-100">
        <img 
